...
from jupyter_packaging import combine_commands, get_version, skip_if_exists
...
class NPM(Command):
    ...
    targets = [
        os.path.join(node_root, 'lib', 'extension.js'),
        os.path.join(node_root, 'lib', 'index.js')
    ]
...
setup_args = dict(
    ...
    url='https://github.com/x-turtle/ipyxturtle',
    keywords=[
        'ipython',
        'jupyter',
        'widgets',
